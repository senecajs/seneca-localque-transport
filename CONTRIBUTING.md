...
If you plocalque-transport, add the following configuration to format your conde on save:
...
Feel free to
[open an Issue](https://github.com/senecajs/seneca-localque-transport/issues).
